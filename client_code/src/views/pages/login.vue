  ...
  <div>
    <div class="login_view">
      <div class="outTitle_view">
        <div class="outTilte">基于SpringBoot高校毕业生招聘就业管理系统登录</div>
      </div>
      <el-form :model="loginForm" class="login_form">
        ...
        <div class="btn_view">
          ...
          <el-button
            class="register"
            type="primary"
            @click="handleRegister('daxueshengyonghu')"
            >注册大学生用户</el-button
          >
          <el-button
            class="register"
            type="primary"
            @click="handleRegister('qiyeyonghu')"
            >注册企业用户</el-button
          >
        </div>
      </el-form>
...
.login_view {
  ...
  background: url(http://localhost:8080/collegeEmployment/file/502df44310e74a87b24f97b4fc60158c.jpg);
  display: flex;
  min-height: 100vh;
