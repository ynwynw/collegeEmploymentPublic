  ...
  >
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">公司要求</div>
          <div class="info_text">{{ detail.gongsiyaoqiu }}</div>
        </div>
        <div class="info_item">
          <div class="info_label">公司要求学历</div>
          <div class="info_text">{{ detail.gongsiyaoqiuxueli }}</div>
        </div>
        <div class="info_item">
          <div class="info_label">岗位专业</div>
          <div class="info_text">{{ detail.gangweizhuanye }}</div>
        </div>
        <div class="info_item">
        ...
        <div class="btn_view">
          <el-button
            class="cross_btn"
            v-if="btnFrontAuth(tableName, '应聘')"
            @click="
              gangweiyingpinonAcross(
                '应聘',
                'gangweiyingpin',
                '是',
                '[1]',
          ...
          <el-button
            class="cross_btn"
            v-if="btnFrontAuth(tableName, '在线咨询')"
            @click="
              zaixianzixunonAcross('在线咨询', 'zaixianzixun', '是', '', '')
            "
            type="warning"
            >在线咨询</el-button
          >
          <el-button
            class="approval_btn"
            v-if="btnAuth('xiaozhaogangweifabu', '审核')"
            type="warning"
            @click="approvalClick()"
            >审核</el-button
          >
          <el-button
            v-if="
              ...
              btnFrontAuth('xiaozhaogangweifabu', '支付')
            "
            class="approval_btn"
            @click="payClick"
            >支付</el-button
          ...
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('xiaozhaogangweifabu', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('xiaozhaogangweifabu', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
...
const getDetail = () => {
  context
    ...
    .then((res) => {
      ...
      bannerList.value = res.data.data.fengmian
        ? res.data.data.fengmian.split(',')
        : []
