  ...
  >
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">专业名称</div>
          <div class="info_text">{{ detail.zhuanyemingcheng }}</div>
        </div>
        ...
        <div class="btn_view">
          <el-button
            class="approval_btn"
            v-if="btnAuth('yunxuanjiangshipin', '审核')"
            type="warning"
            @click="approvalClick()"
            >审核</el-button
          >
          <el-button
            v-if="
              ...
              btnFrontAuth('yunxuanjiangshipin', '支付')
            "
            class="approval_btn"
            @click="payClick"
            >支付</el-button
          ...
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('yunxuanjiangshipin', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('yunxuanjiangshipin', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
...
const getDetail = () => {
  context
    ...
    .then((res) => {
      title.value = res.data.data.shipinbiaoti
