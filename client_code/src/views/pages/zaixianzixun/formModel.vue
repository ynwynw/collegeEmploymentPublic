  ...
  >
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">咨询内容</div>
          <div class="info_text">{{ detail.zixunneirong }}</div>
        </div>
        <div class="info_item">
        ...
        <div class="btn_view">
          ...
          <el-button
            class="edit_btn"
            v-if="centerType && btnAuth('zaixianzixun', '修改')"
            type="primary"
            @click="editClick"
            >修改</el-button
          >
          <el-button
            class="del_btn"
            v-if="centerType && btnAuth('zaixianzixun', '删除')"
            type="danger"
            @click="delClick"
            >删除</el-button
          >
